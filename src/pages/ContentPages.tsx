        ...
        <div className="grid lg:grid-cols-2 gap-20 items-stretch mb-20">
          ...
          >
            ...
            <div className="space-y-8">
              {[
                { icon: MapPin, title: 'Corporate HQ', text: '362/7, 2nd Floor, Synerge Workspace, 16th Main, Jayanagar, Bangalore 560041' },
                { icon: Phone, title: 'Technical Desk', text: '+91 87226 42718, +91 99458 43434' },
                { icon: Mail, title: 'Direct Access', text: 'solutions@autolinkinfotech.com' },
