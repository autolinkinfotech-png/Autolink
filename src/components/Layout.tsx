  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? 'bg-white/90 backdrop-blur-md h-20 md:h-20 border-b border-slate-200 shadow-xl shadow-slate-200/20'
      ...
      <div className="container mx-auto px-4 md:px-6 h-full">
        <nav className="flex items-center justify-between h-full">
          <Link to="/" className="flex items-center group">
            <div className="h-20 md:h-32 w-auto flex items-center justify-center transition-transform duration-500 group-hover:scale-105 pt-1 md:pt-5">
