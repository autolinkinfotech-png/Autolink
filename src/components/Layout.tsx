  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? 'bg-white/90 backdrop-blur-md h-24 md:h-28 border-b border-slate-200 shadow-xl shadow-slate-200/20'
      ...
      <div className="container mx-auto px-4 md:px-6 h-full">
        <nav className="flex items-center justify-between h-full">
          <Link to="/" className="flex items-center group">
            <div className="h-24 md:h-32 w-auto flex items-center justify-center transition-transform duration-500 group-hover:scale-105 pt-1 md:pt-4">
              <img src={LOGO} alt="Autolink" className="max-h-full w-auto object-contain" referrerPolicy="no-referrer" />
            </div>
          </Link>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div className="space-y-8">
            <Link to="/" className="flex items-center gap-3">
              <div className="w-32 h-32 flex items-center justify-center bg-white/5 rounded-2xl p-2 font-black text-xl text-white">
                <img src={LOGO} alt="Autolink Logo" className="w-full h-full object-contain" referrerPolicy="no-referrer" />
              </div>
            </Link>
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="flex gap-3 md:gap-5">
                ...
                <p className="text-xs sm:text-sm font-bold text-slate-300 leading-relaxed max-w-[180px]">
                  362/7, 2nd Floor, Synerge Workspace, 16th Main, 4th T Block East, Jayanagar, Bengaluru, Karnataka 560041
                </p>
              </div>
              <div className="flex gap-3 md:gap-5">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-[1.25rem] bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-xs sm:text-sm font-bold text-slate-200">+91 87226 42718</p>
                  <p className="text-xs sm:text-sm font-bold text-slate-200">+91 99458 43434</p>
                </div>
              </div>
            </div>
          </div>
